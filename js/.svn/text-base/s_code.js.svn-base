...
/* s_code */
/************************* Report Suite ID Assigning ****************/
//var s_account="lge"+document.URL.split("/")[3].replace("_","");
var s_account="dummy";
if(s_account=="lgegr"){
	s_account="lgehellas";
} else if(s_account=="lgedk" || s_account=="lgefi" || s_account=="lgeno"){
	s_account="lgenordic" + document.URL.split("/")[3].replace("_","");
} else if(s_account=="lgers"){
  s_account="lgesr";
} else if(s_account=="lgese"){
	s_account="lgenordicsv";
}

if(location.host.indexOf("dev")>0 || location.host.indexOf("stg")>0){
	s_account=s_account+"dev";
}
...
s.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx,wma,3gp,3g2"
s.linkInternalFilters="javascript:,http://www.lge.com,http://www.lg.com";
...
/* Internal Campaign */
if(!s.eVar13)
  s.eVar13=s.getQueryParam('intcmp'); 	// Parameter may be different from intcmp
  
s.clickThruQuality('s_kwcid','event18','event19'); // Click-through Quality plug-in

/* SMG-659 Omniture ���� tracking ������ ���� s_code ���� ��û parkjeongho delete*/

s.prop12=s.getAndPersistValue(s.campaign,'s_cp_persist',0); // campaign pathing

if(s.getQueryParam('s_kwcid')) s.pageURL=s.manageQueryParam('s_kwcid',1,1); // ONLY encode for SearchCenter 
...
if (s.events) { s.events=s.events + ",event1"; }
...
if ((s_account == 'lgeuk')||(s_account == 'lgeat')||(s_account == 'lgechde')||(s_account == 'lgechfr')||(s_account == 'lgebefr')||(s_account == 'lgebene')||(s_account == 'lgenl')||(s_account == 'lgecz')||(s_account == 'lgede')||(s_account == 'lgees')||(s_account == 'lgefr')||(s_account == 'lgehellas')||(s_account == 'lgeit')||(s_account == 'lgebg')||(s_account == 'lgehr')||(s_account == 'lgehu')||(s_account == 'lgesr')||(s_account == 'lgepl')||(s_account == 'lgept')||(s_account == 'lgero')||(s_account == 'lgenordicdk')||(s_account == 'lgenordicfi')||(s_account == 'lgenordicno')||(s_account == 'lgenordicsv')||(s_account == 'lgeie') ||(s_account == 'lgesk')) {
s.loadModule("Survey")
...
s.trackingServer="tracking.lg.com"
s.visitorMigrationKey="4E5235A2"
s.visitorMigrationServer="lgelectronics.122.2o7.net"
s.visitorMigrationServerSecure="tracking.lg.com"
...
function s_trackTemplate(rsID, templateName){
	var s=s_gi(rsID);
	s.linkTrackVars='prop18,eVar18';
	s.prop18=templateName;
	s.eVar18=s.prop18;
	s.tl(true,'o','Template Tracking:'+templateName);
}

/* omniture - 20100305 parkjeongmi add */
function s_trackFacet(rsID, FacetTypeName){
  var s=s_gi(s_account);
  s.linkTrackVars='prop14';  
  s.prop14=FacetTypeName;
  s.tl(this,'o', 'Facet Filtering');
}

function s_trackPartnerReferral(rsID, PartnerName){
  var s=s_gi(s_account); 
  s.linkTrackVars='eVar6,events';
  s.linkTrackEvents='event6';
  s.events='event6';
  s.eVar6=PartnerName;
  s.tl(this,'o','Partner Referrals');
}
/*//omniture - 20100305 parkjeongmi add */

function scTrackWhereToBuy(){
  var s=s_gi(s_account);                             
  s.linkTrackVars='events,pageName,prop3,prop4,prop5,eVar3,eVar4,eVar5,hier1,products';                  
	s.linkTrackEvents='event11'; s.events='event11';    
	s.tl(this,'o','Where to Buy Searches');
}
	  
function scTrackParterReferralWTB(){
  var s=s_gi(s_account);                             
  s.linkTrackVars='events,pageName,prop3,prop4,prop5,eVar3,eVar4,eVar5,hier1,products';                  
  s.linkTrackEvents='event20'; s.events='event20';    
  s.tl(this,'o','Partner Referrals on Where To Buy');
}
// -- 20100329 Jin Tracking.js Remove
//omniture tagging function 
function tagLink(obj, type, page, tag){
	var tagName =  (tag == null || tag == 'undefined')? $(obj).attr('trackingInfo'):tag;
	var pageName = (page == null || page == 'undefined')? $(obj).attr('pageName'):page;
	s.pageName = pageName;
	s.eVar12 = tagName;
    if ( type == 'exit_link'){
		s.linkTrackVars='eVar12,events';
		s.linkTrackEvents='event3'; s.events='event3';
		s.tl(obj, 'o', tagName);		    
